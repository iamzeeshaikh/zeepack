...
export const metadata = createMetadata({
  ...
  description: "Review the terms and conditions for the ZEEPACK website and packaging inquiries.",
    ...
    <section className="section-space">
      <Container className="surface-card max-w-4xl p-7 sm:p-9">
        ...
        <div className="mt-6 grid gap-4 text-base leading-8 text-[var(--color-muted)]">
          <p>All website content is provided for informational and marketing purposes related to premium custom packaging and quote generation.</p>
