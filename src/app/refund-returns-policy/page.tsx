    ...
    <section className="section-space">
      <Container className="surface-card max-w-4xl p-7 sm:p-9">
        ...
        <div className="mt-6 grid gap-4 text-base leading-8 text-[var(--color-muted)]">
          <p>Because custom cereal boxes and printed packaging are made to project specifications, returns are generally not accepted after production approval unless an error is confirmed.</p>
