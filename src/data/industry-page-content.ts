...
export const industryPageContent: Record<string, IndustryPageContent> = {
  cosmetics: {
    ...
    supportImage: "/images/zee/cosmetic-serum-box.jpg",
    priorityCards: [
  ...
  candles: {
    ...
    supportImage: "/images/zee/candle-boxes.jpg",
    priorityCards: [
  ...
  jewelry: {
    ...
    supportImage: "/images/zee/jewelry-cotton-box.jpg",
    priorityCards: [
  ...
  food: {
    ...
    trustPills: ["Custom Sizes", "Premium Finishes", "Low Minimums", "Retail Ready"],
    supportImage: "/images/zee/food-frozen-box.jpg",
    priorityCards: [
  ...
  ecommerce: {
    ...
    supportImage: "/images/zee/mailer-blank.jpg",
    priorityCards: [
...
const generatedIndustryContent: Record<string, IndustryPageContent> = {
  ...
  "subscription-boxes": makeIndustryContent({
    ...
    image: "/images/industries/subscription-boxes.jpg",
  ...
  cbd: makeIndustryContent({
    ...
    image: "/images/industries/cbd.jpg",
  ...
  "pet-products": makeIndustryContent({
    ...
    image: "/images/industries/pet-products.jpg",
  ...
  "corporate-gifts": makeIndustryContent({
    ...
    image: "/images/industries/corporate-gifts.jpg",
  ...
  confectionery: makeIndustryContent({
    ...
    image: "/images/industries/confectionery.jpg",
...
const simpleIndustries = [
  { slug: "bakery", name: "Bakery", category: "bakery", image: "/images/zee/bakery-divider-box.jpg", related: ["bakery-boxes", "window-boxes", "food-boxes"], industries: ["food", "confectionery", "cafe"] },
  { slug: "coffee-tea", name: "Coffee & Tea", category: "coffee and tea", image: "/images/zee/kraft-gift-box.jpg", related: ["coffee-tea-boxes", "mylar-bags", "labels-and-stickers"], industries: ["cafe", "gourmet-food", "subscription-boxes"] },
  ...
  { slug: "soap-bath", name: "Soap & Bath", category: "soap and bath", image: "/images/zee/soap-brown-box.jpg", related: ["soap-boxes", "window-boxes", "kraft-boxes"], industries: ["wellness", "organic-products", "aromatherapy"] },
  { slug: "wellness", name: "Wellness", category: "wellness", image: "/images/industries/health-wellness.jpg", related: ["supplement-packaging", "folding-cartons", "rigid-boxes"], industries: ["health-wellness", "supplements", "fitness"] },
  { slug: "fitness", name: "Fitness", category: "fitness and sports nutrition", image: "/images/zee/supplement-dietary-box.jpg", related: ["supplement-packaging", "mylar-bags", "display-boxes"], industries: ["supplements", "health-wellness", "protein-fitness"] },
  ...
  { slug: "aromatherapy", name: "Aromatherapy", category: "aromatherapy", image: "/images/zee/candle-dust-cover.jpg", related: ["cosmetic-boxes", "inserts", "gift-boxes"], industries: ["essential-oils", "wellness", "spa-wellness"] },
  { slug: "essential-oils", name: "Essential Oils", category: "essential oil", image: "/images/zee/perfume-flip-box.jpg", related: ["cosmetic-boxes", "inserts", "rigid-boxes"], industries: ["aromatherapy", "wellness", "soap-bath"] },
  ...
  { slug: "home-decor", name: "Home Décor", category: "home décor", image: "/images/zee/rigid-lid-box.jpg", related: ["gift-boxes", "rigid-boxes", "tissue-paper"], industries: ["luxury-fashion", "boutique-retail", "wedding-events"] },
  ...
  { slug: "restaurant", name: "Restaurant", category: "restaurant and foodservice", image: "/images/zee/food-frozen-box.jpg", related: ["food-boxes", "bakery-boxes", "labels-and-stickers"], industries: ["cafe", "gourmet-food", "artisan-food"] },
  { slug: "cafe", name: "Café & Coffee Shop", category: "café", image: "/images/zee/paper-bag-bakery.jpg", related: ["coffee-tea-boxes", "sleeves", "bakery-boxes"], industries: ["restaurant", "coffee-tea", "specialty-coffee"] },
  ...
  { slug: "wedding-events", name: "Wedding & Events", category: "wedding and event", image: "/images/zee/gift-popup-box.jpg", related: ["gift-boxes", "rigid-boxes", "tissue-paper"], industries: ["luxury-gifts", "confectionery", "jewelry"] },
  { slug: "holiday-seasonal", name: "Holiday & Seasonal", category: "holiday and seasonal", image: "/images/zee/gift-chocolate-box.jpg", related: ["gift-boxes", "mailer-boxes", "tissue-paper"], industries: ["christmas", "confectionery", "corporate-gifts"] },
  { slug: "luxury-fashion", name: "Luxury Fashion", category: "luxury fashion", image: "/images/zee/sleeve-apparel.jpg", related: ["paper-bags", "tissue-paper", "rigid-boxes"], industries: ["boutique-retail", "jewelry", "accessories"] },
  { slug: "footwear", name: "Footwear", category: "footwear", image: "/images/zee/rigid-shoulder-box.jpg", related: ["rigid-boxes", "tissue-paper", "paper-bags"], industries: ["luxury-fashion", "accessories", "boutique-retail"] },
  { slug: "accessories", name: "Accessories", category: "accessories", image: "/images/zee/jewelry-cotton-box.jpg", related: ["gift-boxes", "rigid-boxes", "inserts"], industries: ["jewelry", "luxury-fashion", "boutique-retail"] },
  { slug: "chocolate", name: "Chocolate", category: "chocolate", image: "/images/zee/gift-chocolate-box.jpg", related: ["candy-boxes", "food-boxes", "gift-boxes"], industries: ["confectionery", "gourmet-food", "bakery"] },
  { slug: "tea-brands", name: "Tea Brands", category: "specialty tea", image: "/images/zee/kraft-recycled-box.jpg", related: ["coffee-tea-boxes", "mylar-bags", "rigid-boxes"], industries: ["coffee-tea", "wellness", "gourmet-food"] },
  { slug: "gourmet-food", name: "Gourmet Food", category: "gourmet and specialty food", image: "/images/zee/bakery-divider-box.jpg", related: ["food-boxes", "gift-boxes", "window-boxes"], industries: ["artisan-food", "chocolate", "confectionery"] },
  { slug: "craft-beverage", name: "Craft Beverage", category: "craft beverage", image: "/images/zee/kraft-gift-box.jpg", related: ["gift-boxes", "labels-and-stickers", "paper-bags"], industries: ["wine-spirits", "luxury-spirits", "kombucha"] },
  { slug: "spa-wellness", name: "Spa & Wellness", category: "spa and wellness", image: "/images/zee/candle-dust-cover.jpg", related: ["gift-boxes", "soap-boxes", "rigid-boxes"], industries: ["wellness", "yoga-meditation", "aromatherapy"] },
  { slug: "corporate-events", name: "Corporate Events", category: "corporate events", image: "/images/industries/corporate-gifts.jpg", related: ["gift-boxes", "mailer-boxes", "labels-and-stickers"], industries: ["corporate-gifts", "ecommerce", "luxury-gifts"] },
  { slug: "influencer-brands", name: "Influencer Brands", category: "influencer and creator", image: "/images/zee/mailer-with-inserts.jpg", related: ["mailer-boxes", "tissue-paper", "gift-boxes"], industries: ["ecommerce", "subscription-boxes", "social-commerce"] },
  { slug: "tech-accessories", name: "Tech Accessories", category: "tech accessories", image: "/images/industries/electronics.jpg", related: ["display-boxes", "product-boxes", "inserts"], industries: ["electronics", "gaming", "corporate-gifts"] },
  ...
  { slug: "stationery", name: "Stationery", category: "stationery and paper goods", image: "/images/zee/gift-stationery-box.jpg", related: ["sleeves", "folding-cartons", "gift-boxes"], industries: ["boutique-retail", "wedding-events", "art-craft"] },
  { slug: "gift-baskets", name: "Gift Baskets", category: "gift baskets and hampers", image: "/images/zee/gift-gable-box.jpg", related: ["gift-boxes", "rigid-boxes", "tissue-paper"], industries: ["luxury-gifts", "corporate-gifts", "holiday-seasonal"] },
  { slug: "protein-fitness", name: "Protein & Sports Nutrition", category: "protein and sports nutrition", image: "/images/zee/supplement-dietary-box.jpg", related: ["mylar-bags", "supplement-packaging", "display-boxes"], industries: ["fitness", "supplements", "health-wellness"] },
  { slug: "sleep-health", name: "Sleep Health", category: "sleep health", image: "/images/zee/supplement-cardboard-box.jpg", related: ["supplement-packaging", "folding-cartons", "rigid-boxes"], industries: ["wellness", "health-wellness", "immune-health"] },
  { slug: "immune-health", name: "Immune Health", category: "immune health", image: "/images/industries/health-wellness.jpg", related: ["supplement-packaging", "display-boxes", "folding-cartons"], industries: ["health-wellness", "supplements", "wellness"] },
  ...
  { slug: "christmas", name: "Christmas", category: "Christmas holiday", image: "/images/zee/bakery-christmas-box.jpg", related: ["gift-boxes", "rigid-boxes", "tissue-paper"], industries: ["holiday-seasonal", "luxury-gifts", "confectionery"] },
  { slug: "mothers-day", name: "Mother's Day", category: "Mother's Day", image: "/images/zee/gift-popup-box.jpg", related: ["gift-boxes", "rigid-boxes", "tissue-paper"], industries: ["holiday-seasonal", "cosmetics", "luxury-gifts"] },
  { slug: "graduation", name: "Graduation", category: "graduation gifting", image: "/images/zee/gift-stationery-box.jpg", related: ["gift-boxes", "rigid-boxes", "labels-and-stickers"], industries: ["corporate-gifts", "luxury-gifts", "stationery"] },
  { slug: "artisan-food", name: "Artisan Food", category: "artisan and small-batch food", image: "/images/zee/bakery-divider-box.jpg", related: ["food-boxes", "kraft-boxes", "window-boxes"], industries: ["gourmet-food", "bakery", "farmers-market"] },
  ...
  { slug: "pop-up-retail", name: "Pop-Up Retail", category: "pop-up retail", image: "/images/zee/display-counter-box.jpg", related: ["paper-bags", "tissue-paper", "labels-and-stickers"], industries: ["boutique-retail", "farmers-market", "holiday-seasonal"] },
  { slug: "hospitality", name: "Hospitality", category: "hospitality", image: "/images/zee/paper-bag-bakery.jpg", related: ["gift-boxes", "rigid-boxes", "soap-boxes"], industries: ["spa-wellness", "luxury-gifts", "corporate-gifts"] },
  ...
  { slug: "veterinary", name: "Veterinary & Pet Health", category: "veterinary and pet health", image: "/images/industries/pet-products.jpg", related: ["supplement-packaging", "folding-cartons", "display-boxes"], industries: ["pet-products", "pet-treats", "health-wellness"] },
  ...
  { slug: "sexual-wellness", name: "Sexual Wellness", category: "sexual wellness", image: "/images/zee/rigid-foldable-box.jpg", related: ["rigid-boxes", "mailer-boxes", "product-boxes"], industries: ["wellness", "health-wellness", "luxury-gifts"] },
  ...
  { slug: "kombucha", name: "Kombucha", category: "kombucha and fermented drinks", image: "/images/zee/kraft-recycled-box.jpg", related: ["labels-and-stickers", "sleeves", "gift-boxes"], industries: ["craft-beverage", "wellness", "tea-brands"] },
  { slug: "farmers-market", name: "Farmer's Market", category: "farmer's market", image: "/images/zee/paper-bag-kraft.jpg", related: ["kraft-boxes", "labels-and-stickers", "paper-bags"], industries: ["artisan-food", "natural-organic", "pop-up-retail"] },
  ...
  { slug: "collagen-beauty", name: "Collagen & Beauty Supplements", category: "collagen and beauty supplements", image: "/images/zee/cosmetic-jar-box.jpg", related: ["supplement-packaging", "rigid-boxes", "gift-boxes"], industries: ["supplements", "skincare", "health-wellness"] },
  { slug: "pet-treats", name: "Pet Treats", category: "pet treats and snacks", image: "/images/industries/pet-products.jpg", related: ["mylar-bags", "food-boxes", "display-boxes"], industries: ["pet-products", "veterinary", "natural-organic"] },
