...
const generatedIndustryContent: Record<string, IndustryPageContent> = {
  perfume: makeIndustryContent({
    ...
    gallery: ["/images/products/perfume-box-1.webp", "/images/products/perfume-box-3.webp", "/images/products/rigid-box-3.webp"],
  ...
  "subscription-boxes": makeIndustryContent({
    ...
    gallery: ["/images/products/mailer-box-2.webp", "/images/products/mailer-box-1.webp", "/images/products/tissue-paper-1.webp"],
    relatedCategorySlugs: ["mailer-boxes", "custom-tissue-paper", "inserts"],
  ...
  cbd: makeIndustryContent({
    ...
    gallery: ["/images/products/cbd-box-1.webp", "/images/products/cbd-box-2.webp", "/images/products/display-box-1.webp"],
  ...
  electronics: makeIndustryContent({
    ...
    gallery: ["/images/products/display-box-2.webp", "/images/products/display-box-1.webp", "/images/products/rigid-box-3.webp"],
  ...
  "luxury-gifts": makeIndustryContent({
    ...
    gallery: ["/images/products/gift-box-3.webp", "/images/products/rigid-box-2.webp", "/images/products/gift-box-2.webp"],
  ...
  "health-wellness": makeIndustryContent({
    ...
    gallery: ["/images/products/supplement-box-1.webp", "/images/products/display-box-1.webp", "/images/products/folding-carton-1.webp"],
  ...
  supplements: makeIndustryContent({
    ...
    gallery: ["/images/products/supplement-box-1.webp", "/images/products/supplement-box-2.webp", "/images/products/display-box-1.webp"],
  ...
  "pet-products": makeIndustryContent({
    ...
    gallery: ["/images/products/supplement-box-1.webp", "/images/products/cbd-box-2.webp", "/images/products/display-box-1.webp"],
  ...
  "corporate-gifts": makeIndustryContent({
    ...
    gallery: ["/images/products/gift-box-4.webp", "/images/products/gift-box-2.webp", "/images/products/rigid-box-2.webp"],
    relatedCategorySlugs: ["gift-boxes", "rigid-boxes", "inserts"],
  ...
  confectionery: makeIndustryContent({
    ...
    gallery: ["/images/products/bakery-box-2.webp", "/images/products/bakery-box-2.webp", "/images/products/window-box-1.webp"],
...
const simpleIndustries = [
  { slug: "bakery", name: "Bakery", category: "bakery", image: "/images/products/bakery-box-1.webp", related: ["bakery-boxes", "window-boxes", "food-boxes"], industries: ["food", "confectionery", "cafe"] },
  { slug: "coffee-tea", name: "Coffee & Tea", category: "coffee and tea", image: "/images/products/food-box-3.webp", related: ["coffee-tea-boxes", "mylar-bags", "labels-and-stickers"], industries: ["cafe", "gourmet-food", "subscription-boxes"] },
  { slug: "skincare", name: "Skincare", category: "skincare", image: "/images/products/cosmetic-box-1.webp", related: ["cosmetic-boxes", "rigid-boxes", "folding-cartons"], industries: ["cosmetics", "health-wellness", "vegan-beauty"] },
  { slug: "hair-care", name: "Hair Care", category: "hair care", image: "/images/products/cosmetic-box-1.webp", related: ["cosmetic-boxes", "folding-cartons", "labels-and-stickers"], industries: ["cosmetics", "wellness", "mens-grooming"] },
  { slug: "mens-grooming", name: "Men's Grooming", category: "men's grooming", image: "/images/clean/product-boxes.webp", related: ["product-boxes", "rigid-boxes", "cosmetic-boxes"], industries: ["cosmetics", "skincare", "wellness"] },
  { slug: "soap-bath", name: "Soap & Bath", category: "soap and bath", image: "/images/products/soap-box-1.webp", related: ["soap-boxes", "window-boxes", "kraft-boxes"], industries: ["wellness", "organic-products", "aromatherapy"] },
  ...
  { slug: "fitness", name: "Fitness", category: "fitness and sports nutrition", image: "/images/products/supplement-box-1.webp", related: ["supplement-packaging", "mylar-bags", "display-boxes"], industries: ["supplements", "health-wellness", "protein-fitness"] },
  { slug: "organic-products", name: "Organic Products", category: "organic", image: "/images/products/kraft-box-1.webp", related: ["kraft-boxes", "sustainable-packaging", "window-boxes"], industries: ["natural-organic", "vegan-beauty", "artisan-food"] },
  ...
  { slug: "baby-products", name: "Baby Products", category: "baby and infant", image: "/images/products/gift-box-1.webp", related: ["gift-boxes", "rigid-boxes", "tissue-paper"], industries: ["maternity", "kids-toys", "wellness"] },
  { slug: "kids-toys", name: "Kids & Toys", category: "children's products", image: "/images/clean/product-boxes.webp", related: ["product-boxes", "window-boxes", "display-boxes"], industries: ["baby-products", "holiday-seasonal", "art-craft"] },
  { slug: "home-decor", name: "Home Décor", category: "home décor", image: "/images/products/gift-box-4.webp", related: ["gift-boxes", "rigid-boxes", "tissue-paper"], industries: ["luxury-fashion", "boutique-retail", "wedding-events"] },
  { slug: "wine-spirits", name: "Wine & Spirits", category: "wine and spirits", image: "/images/products/gift-box-2.webp", related: ["gift-boxes", "rigid-boxes", "inserts"], industries: ["luxury-spirits", "craft-beverage", "corporate-gifts"] },
  { slug: "restaurant", name: "Restaurant", category: "restaurant and foodservice", image: "/images/products/food-box-1.webp", related: ["food-boxes", "bakery-boxes", "labels-and-stickers"], industries: ["cafe", "gourmet-food", "artisan-food"] },
  { slug: "cafe", name: "Café & Coffee Shop", category: "café", image: "/images/products/food-box-3.webp", related: ["coffee-tea-boxes", "sleeves", "bakery-boxes"], industries: ["restaurant", "coffee-tea", "specialty-coffee"] },
  { slug: "boutique-retail", name: "Boutique Retail", category: "boutique retail", image: "/images/products/paper-bag-1.webp", related: ["paper-bags", "tissue-paper", "rigid-boxes"], industries: ["luxury-fashion", "jewelry", "home-decor"] },
  { slug: "wedding-events", name: "Wedding & Events", category: "wedding and event", image: "/images/products/gift-box-1.webp", related: ["gift-boxes", "rigid-boxes", "tissue-paper"], industries: ["luxury-gifts", "confectionery", "jewelry"] },
  { slug: "holiday-seasonal", name: "Holiday & Seasonal", category: "holiday and seasonal", image: "/images/products/gift-box-4.webp", related: ["gift-boxes", "mailer-boxes", "tissue-paper"], industries: ["christmas", "confectionery", "corporate-gifts"] },
  ...
  { slug: "footwear", name: "Footwear", category: "footwear", image: "/images/products/rigid-box-1.webp", related: ["rigid-boxes", "tissue-paper", "paper-bags"], industries: ["luxury-fashion", "accessories", "boutique-retail"] },
  { slug: "accessories", name: "Accessories", category: "accessories", image: "/images/products/gift-box-3.webp", related: ["gift-boxes", "rigid-boxes", "inserts"], industries: ["jewelry", "luxury-fashion", "boutique-retail"] },
  { slug: "chocolate", name: "Chocolate", category: "chocolate", image: "/images/products/bakery-box-2.webp", related: ["candy-boxes", "food-boxes", "gift-boxes"], industries: ["confectionery", "gourmet-food", "bakery"] },
  { slug: "tea-brands", name: "Tea Brands", category: "specialty tea", image: "/images/products/kraft-box-2.webp", related: ["coffee-tea-boxes", "mylar-bags", "rigid-boxes"], industries: ["coffee-tea", "wellness", "gourmet-food"] },
  { slug: "gourmet-food", name: "Gourmet Food", category: "gourmet and specialty food", image: "/images/products/food-box-1.webp", related: ["food-boxes", "gift-boxes", "window-boxes"], industries: ["artisan-food", "chocolate", "confectionery"] },
  { slug: "craft-beverage", name: "Craft Beverage", category: "craft beverage", image: "/images/products/rigid-box-3.webp", related: ["gift-boxes", "labels-and-stickers", "paper-bags"], industries: ["wine-spirits", "luxury-spirits", "kombucha"] },
  { slug: "spa-wellness", name: "Spa & Wellness", category: "spa and wellness", image: "/images/products/soap-box-1.webp", related: ["gift-boxes", "soap-boxes", "rigid-boxes"], industries: ["wellness", "yoga-meditation", "aromatherapy"] },
  ...
  { slug: "influencer-brands", name: "Influencer Brands", category: "influencer and creator", image: "/images/products/mailer-box-1.webp", related: ["mailer-boxes", "tissue-paper", "gift-boxes"], industries: ["ecommerce", "subscription-boxes", "social-commerce"] },
  ...
  { slug: "vegan-beauty", name: "Vegan Beauty", category: "vegan and clean beauty", image: "/images/products/cosmetic-box-1.webp", related: ["sustainable-packaging", "kraft-boxes", "folding-cartons"], industries: ["organic-products", "cosmetics", "skincare"] },
  { slug: "pharmacy", name: "Pharmacy & OTC", category: "pharmacy and OTC health", image: "/images/products/supplement-box-1.webp", related: ["folding-cartons", "display-boxes", "supplement-packaging"], industries: ["health-wellness", "supplements", "dental"] },
  { slug: "natural-organic", name: "Natural & Organic", category: "natural and organic", image: "/images/products/kraft-box-1.webp", related: ["kraft-boxes", "sustainable-packaging", "window-boxes"], industries: ["organic-products", "vegan-beauty", "soap-bath"] },
  { slug: "stationery", name: "Stationery", category: "stationery and paper goods", image: "/images/products/folding-carton-1.webp", related: ["sleeves", "folding-cartons", "gift-boxes"], industries: ["boutique-retail", "wedding-events", "art-craft"] },
  { slug: "gift-baskets", name: "Gift Baskets", category: "gift baskets and hampers", image: "/images/products/gift-box-4.webp", related: ["gift-boxes", "rigid-boxes", "tissue-paper"], industries: ["luxury-gifts", "corporate-gifts", "holiday-seasonal"] },
  { slug: "protein-fitness", name: "Protein & Sports Nutrition", category: "protein and sports nutrition", image: "/images/products/supplement-box-1.webp", related: ["mylar-bags", "supplement-packaging", "display-boxes"], industries: ["fitness", "supplements", "health-wellness"] },
  { slug: "sleep-health", name: "Sleep Health", category: "sleep health", image: "/images/products/supplement-box-1.webp", related: ["supplement-packaging", "folding-cartons", "rigid-boxes"], industries: ["wellness", "health-wellness", "immune-health"] },
  ...
  { slug: "maternity", name: "Maternity & New Parents", category: "maternity", image: "/images/products/gift-box-1.webp", related: ["gift-boxes", "rigid-boxes", "tissue-paper"], industries: ["baby-products", "wellness", "luxury-gifts"] },
  { slug: "yoga-meditation", name: "Yoga & Meditation", category: "yoga and meditation", image: "/images/products/kraft-box-1.webp", related: ["sustainable-packaging", "kraft-boxes", "labels-and-stickers"], industries: ["wellness", "spa-wellness", "organic-products"] },
  { slug: "art-craft", name: "Art & Craft", category: "art and craft supplies", image: "/images/products/display-box-1.webp", related: ["display-boxes", "product-boxes", "gift-boxes"], industries: ["stationery", "kids-toys", "boutique-retail"] },
  { slug: "outdoor-adventure", name: "Outdoor & Adventure", category: "outdoor and adventure", image: "/images/products/corrugated-box-1.webp", related: ["corrugated-boxes", "display-boxes", "product-boxes"], industries: ["fitness", "cycling", "gaming"] },
  { slug: "gaming", name: "Gaming", category: "gaming", image: "/images/products/rigid-box-1.webp", related: ["rigid-boxes", "display-boxes", "product-boxes"], industries: ["electronics", "tech-accessories", "outdoor-adventure"] },
  { slug: "christmas", name: "Christmas", category: "Christmas holiday", image: "/images/products/gift-box-4.webp", related: ["gift-boxes", "rigid-boxes", "tissue-paper"], industries: ["holiday-seasonal", "luxury-gifts", "confectionery"] },
  { slug: "mothers-day", name: "Mother's Day", category: "Mother's Day", image: "/images/products/gift-box-2.webp", related: ["gift-boxes", "rigid-boxes", "tissue-paper"], industries: ["holiday-seasonal", "cosmetics", "luxury-gifts"] },
  { slug: "graduation", name: "Graduation", category: "graduation gifting", image: "/images/products/gift-box-3.webp", related: ["gift-boxes", "rigid-boxes", "labels-and-stickers"], industries: ["corporate-gifts", "luxury-gifts", "stationery"] },
  { slug: "artisan-food", name: "Artisan Food", category: "artisan and small-batch food", image: "/images/products/kraft-box-1.webp", related: ["food-boxes", "kraft-boxes", "window-boxes"], industries: ["gourmet-food", "bakery", "farmers-market"] },
  { slug: "meal-prep", name: "Meal Prep", category: "meal prep and health food", image: "/images/products/food-box-1.webp", related: ["food-boxes", "labels-and-stickers", "corrugated-boxes"], industries: ["restaurant", "gourmet-food", "vegan-food"] },
  { slug: "vegan-food", name: "Vegan Food", category: "vegan and plant-based food", image: "/images/products/kraft-box-1.webp", related: ["food-boxes", "kraft-boxes", "sustainable-packaging"], industries: ["natural-organic", "artisan-food", "gluten-free"] },
  { slug: "pop-up-retail", name: "Pop-Up Retail", category: "pop-up retail", image: "/images/products/paper-bag-1.webp", related: ["paper-bags", "tissue-paper", "labels-and-stickers"], industries: ["boutique-retail", "farmers-market", "holiday-seasonal"] },
  { slug: "hospitality", name: "Hospitality", category: "hospitality", image: "/images/products/gift-box-2.webp", related: ["gift-boxes", "rigid-boxes", "soap-boxes"], industries: ["spa-wellness", "luxury-gifts", "corporate-gifts"] },
  { slug: "dental", name: "Dental & Oral Health", category: "dental and oral health", image: "/images/products/folding-carton-1.webp", related: ["folding-cartons", "display-boxes", "labels-and-stickers"], industries: ["pharmacy", "health-wellness", "wellness"] },
  ...
  { slug: "keto-diet", name: "Keto & Low-Carb", category: "keto and low-carb", image: "/images/products/food-box-1.webp", related: ["food-boxes", "mylar-bags", "supplement-packaging"], industries: ["vegan-food", "meal-prep", "health-wellness"] },
  { slug: "gluten-free", name: "Gluten-Free", category: "gluten-free food", image: "/images/products/food-box-2.webp", related: ["food-boxes", "folding-cartons", "labels-and-stickers"], industries: ["artisan-food", "vegan-food", "bakery"] },
  { slug: "energy-drinks", name: "Energy Drinks", category: "energy and functional drinks", image: "/images/clean/product-boxes.webp", related: ["sleeves", "display-boxes", "labels-and-stickers"], industries: ["craft-beverage", "fitness", "protein-fitness"] },
  { slug: "sexual-wellness", name: "Sexual Wellness", category: "sexual wellness", image: "/images/products/rigid-box-3.webp", related: ["rigid-boxes", "mailer-boxes", "product-boxes"], industries: ["wellness", "health-wellness", "luxury-gifts"] },
  { slug: "photography", name: "Photography", category: "photography and creative", image: "/images/products/rigid-box-1.webp", related: ["rigid-boxes", "product-boxes", "tissue-paper"], industries: ["art-craft", "stationery", "boutique-retail"] },
  { slug: "watches", name: "Watches", category: "watches and timepieces", image: "/images/products/jewelry-box-1.webp", related: ["rigid-boxes", "jewelry-boxes", "inserts"], industries: ["jewelry", "luxury-fashion", "accessories"] },
  { slug: "cycling", name: "Cycling", category: "cycling and bike accessories", image: "/images/products/corrugated-box-1.webp", related: ["corrugated-boxes", "display-boxes", "product-boxes"], industries: ["outdoor-adventure", "fitness", "gaming"] },
  { slug: "music", name: "Music & Instruments", category: "music and instruments", image: "/images/products/rigid-box-1.webp", related: ["rigid-boxes", "product-boxes", "inserts"], industries: ["art-craft", "kids-toys", "stationery"] },
  { slug: "kombucha", name: "Kombucha", category: "kombucha and fermented drinks", image: "/images/products/food-box-3.webp", related: ["labels-and-stickers", "sleeves", "gift-boxes"], industries: ["craft-beverage", "wellness", "tea-brands"] },
  { slug: "farmers-market", name: "Farmer's Market", category: "farmer's market", image: "/images/products/kraft-box-1.webp", related: ["kraft-boxes", "labels-and-stickers", "paper-bags"], industries: ["artisan-food", "natural-organic", "pop-up-retail"] },
  { slug: "luxury-spirits", name: "Luxury Spirits", category: "luxury spirits", image: "/images/products/gift-box-2.webp", related: ["rigid-boxes", "gift-boxes", "inserts"], industries: ["wine-spirits", "craft-beverage", "corporate-gifts"] },
  ...
  { slug: "eyewear", name: "Eyewear", category: "eyewear and sunglasses", image: "/images/products/rigid-box-1.webp", related: ["rigid-boxes", "inserts", "product-boxes"], industries: ["accessories", "luxury-fashion", "boutique-retail"] },
  { slug: "spices-herbs", name: "Spices & Herbs", category: "spices and herbs", image: "/images/products/food-box-2.webp", related: ["labels-and-stickers", "food-boxes", "gift-boxes"], industries: ["gourmet-food", "artisan-food", "farmers-market"] },
  { slug: "specialty-coffee", name: "Specialty Coffee", category: "specialty coffee", image: "/images/products/food-box-3.webp", related: ["coffee-tea-boxes", "mylar-bags", "gift-boxes"], industries: ["coffee-tea", "cafe", "gourmet-food"] },
  { slug: "social-commerce", name: "Social Commerce", category: "social commerce and creator brands", image: "/images/products/mailer-box-1.webp", related: ["mailer-boxes", "tissue-paper", "gift-boxes"], industries: ["influencer-brands", "ecommerce", "subscription-boxes"] },
];
...
simpleIndustries.forEach(({ slug, name, category, image, related, industries: relatedIndustries }) => {
  if (!generatedIndustryContent[slug]) {
    generatedIndustryContent[slug] = makeIndustryContent({
      ...
      image,
      gallery: [image, "/images/products/rigid-box-3.webp", "/images/products/mailer-box-1.webp"],
